...
class RegistrationControllerTest extends WebTestCase
{
    ...
    public function testRegister(): void
    {
        ...
        self::assertEmailAddressContains($messages[0], 'from', 'dencaussepaulfranck@hotmail.com');
        ...
        self::assertTrue(static::getContainer()->get(AdminRepository::class)->findAll()[0]->isVerified());
    }
}
